...
RSpec.describe BackgroundsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested background as @background" do
      background = Background.create! valid_attributes
      get :show, params: {id: background.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested background as @background" do
      background = Background.create! valid_attributes
      get :edit, params: {id: background.to_param}, session: valid_session
      expect(assigns(:background)).to eq(background)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Background" do
        expect {
          post :create, params: {background: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved background as @background" do
        post :create, params: {background: invalid_attributes}, session: valid_session
        expect(assigns(:background)).to be_a_new(Background)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested background" do
        background = Background.create! valid_attributes
        put :update, params: {id: background.to_param, background: new_attributes}, session: valid_session
        background.reload
      ...
      it "assigns the requested background as @background" do
        background = Background.create! valid_attributes
        put :update, params: {id: background.to_param, background: valid_attributes}, session: valid_session
        expect(assigns(:background)).to eq(background)
      end
    ...
    context "with invalid params" do
      it "assigns the background as @background" do
        background = Background.create! valid_attributes
        put :update, params: {id: background.to_param, background: invalid_attributes}, session: valid_session
        expect(assigns(:background)).to eq(background)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested background" do
      background = Background.create! valid_attributes
      expect {
        delete :destroy, params: {id: background.to_param}, session: valid_session
      }.to change(Background, :count).by(-1)
    end
